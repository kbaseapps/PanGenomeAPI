...
SERVICE_CAPS = PanGenomeAPI
SPEC_FILE = PanGenomeAPI.spec
URL = https://kbase.us/services/pangenomeapi
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
...
build-startup-script:
	...
	echo 'uwsgi --master --processes 5 --threads 5 --http-timeout 300 --worker-reload-mercy 300 -t 300 --http :5000 --wsgi-file $$script_dir/../$(LIB_DIR)/$(SERVICE_CAPS)/$(SERVICE_CAPS)Server.py' >> $(SCRIPTS_DIR)/$(STARTUP_SCRIPT_NAME)
