...
class PangenomeOrthomcl(object):
    ...
    def _check_job(self, job_id):
        return self._client._check_job('PangenomeOrthomcl', job_id)

    def _build_pangenome_with_orthomcl_submit(self, params, context=None):
        return self._client._submit_job(
             'PangenomeOrthomcl.build_pangenome_with_orthomcl', [params],
    ...
    def build_pangenome_with_orthomcl(self, params, context=None):
        ...
        """
        job_id = self._build_pangenome_with_orthomcl_submit(params, context)
    ...
    def status(self, context=None):
        job_id = self._client._submit_job('PangenomeOrthomcl.status', 
            [], self._service_ver, context)
        async_job_check_time = self._client.async_job_check_time
        while True:
            time.sleep(async_job_check_time)
