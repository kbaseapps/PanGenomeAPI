...
/**
 * <p>Original spec-file type: SearchOrthologs</p>
 * <pre>
...
public class SearchOrthologs {
    ...
    public SearchOrthologs withRef(java.lang.String ref) {
        this.ref = ref;
        return this;
    }
    ...
    public SearchOrthologs withQuery(java.lang.String query) {
        this.query = query;
        return this;
    }
    ...
    public SearchOrthologs withSortBy(List<Tuple2 <String, Long>> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public SearchOrthologs withStart(java.lang.Long start) {
        this.start = start;
        return this;
    }
    ...
    public SearchOrthologs withLimit(java.lang.Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SearchOrthologs withNumFound(java.lang.Long numFound) {
        this.numFound = numFound;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("SearchOrthologs"+" [ref=")+ ref)+", query=")+ query)+", sortBy=")+ sortBy)+", start=")+ start)+", limit=")+ limit)+", numFound=")+ numFound)+", additionalProperties=")+ additionalProperties)+"]");
    }
