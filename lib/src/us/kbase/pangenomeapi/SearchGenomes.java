...
/**
 * <p>Original spec-file type: SearchGenomes</p>
 * 
 * 
 */
...
public class SearchGenomes {
    ...
    public SearchGenomes withPangenomeRef(java.lang.String pangenomeRef) {
        this.pangenomeRef = pangenomeRef;
        return this;
    }
    ...
    public SearchGenomes withGenomeRef(java.lang.String genomeRef) {
        this.genomeRef = genomeRef;
        return this;
    }
    ...
    public SearchGenomes withQuery(java.lang.String query) {
        this.query = query;
        return this;
    }
    ...
    public SearchGenomes withSortBy(List<Tuple2 <String, Long>> sortBy) {
        this.sortBy = sortBy;
        return this;
    }
    ...
    public SearchGenomes withStart(java.lang.Long start) {
        this.start = start;
        return this;
    }
    ...
    public SearchGenomes withLimit(java.lang.Long limit) {
        this.limit = limit;
        return this;
    }
    ...
    public SearchGenomes withNumFound(java.lang.Long numFound) {
        this.numFound = numFound;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((((("SearchGenomes"+" [pangenomeRef=")+ pangenomeRef)+", genomeRef=")+ genomeRef)+", query=")+ query)+", sortBy=")+ sortBy)+", start=")+ start)+", limit=")+ limit)+", numFound=")+ numFound)+", additionalProperties=")+ additionalProperties)+"]");
    }
