...
/**
 * <p>Original spec-file type: OrthologsData</p>
 * <pre>
...
public class OrthologsData {
    ...
    public OrthologsData withId(java.lang.String id) {
        this.id = id;
        return this;
    }
    ...
    public OrthologsData withType(java.lang.String type) {
        this.type = type;
        return this;
    }
    ...
    public OrthologsData withFunction(java.lang.String function) {
        this.function = function;
        return this;
    }
    ...
    public OrthologsData withMd5(java.lang.String md5) {
        this.md5 = md5;
        return this;
    }
    ...
    public OrthologsData withProteinTranslation(java.lang.String proteinTranslation) {
        this.proteinTranslation = proteinTranslation;
        return this;
    }
    ...
    public OrthologsData withOrthologs(List<Tuple3 <String, Double, String>> orthologs) {
        this.orthologs = orthologs;
        return this;
    }
    ...
    public java.lang.String toString() {
        return ((((((((((((((("OrthologsData"+" [id=")+ id)+", type=")+ type)+", function=")+ function)+", md5=")+ md5)+", proteinTranslation=")+ proteinTranslation)+", orthologs=")+ orthologs)+", additionalProperties=")+ additionalProperties)+"]");
    }
